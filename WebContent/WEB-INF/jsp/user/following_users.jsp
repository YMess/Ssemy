			...
			<div class="usercenter">
				<c:choose>
					...
					<div class="pure-menu pure-menu-open">
						    <a class="pure-menu-heading">I'm Following</a>
							<ul>
								<c:forEach items="${followingUsers}" var="followingUser">
								<c:set var="userEmailId" value="${followingUser.userEmailId }"></c:set>
							...
							<div style="float:left;width:90%;">	
								<a href="user_view_profile.htm?aId=<%=new String(Base64.encodeBase64(String.valueOf(pageContext.getAttribute("userEmailId")).getBytes()))%>"><c:out value="${followingUser.firstName }"/>&nbsp; <c:out value="${followingUser.lastName }"/></a>
							</div>
									</li>
									<br>
								</c:forEach>
