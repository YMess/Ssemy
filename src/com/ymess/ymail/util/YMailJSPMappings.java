...
public class YMailJSPMappings {

	public static final String INBOX_PAGE = "mail/inbox"; //MailActivitiesController
	public static final String DRAFTS_PAGE = "mail/drafts"; //MailActivitiesController
